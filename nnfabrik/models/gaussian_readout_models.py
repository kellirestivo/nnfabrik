...
class SE2dcore(Core2d, nn.Module):
    def __init__(
        ...
        Args:
            ...
            r:              Int. Normalization for Squeeze and Excitation Block.
        """
        ...
        for l in range(1, self.layers):
            ...
            if (self.layers - l) <= self.n_se_blocks:
                layer["seg_ex_block"] = Seq_Ex_Block(in_ch=hidden_channels, r=hidden_channels)
...
def se_core_gauss_readout(dataloaders, seed, hidden_channels=32, input_kern=13,          # core args
                                 ...
                                 gamma_readout=4,  elu_offset=0, stack=None, r=32, n_se_blocks=1,
                                 ):
    """
